function signTheListScreen1() {
    ...
    document.getElementById("media_elements")
        .innerHTML = `
        <audio autoplay class="SoundOfVoice" onended="getCloserToLogInPaper(); clearTheAudio();"><source src="audio/Ral05.wav" type="audio/mpeg"></audio>
        `;
        setVoiceVolume();
    z = 17;
}
...
function signThePaper() {
    ...
    document.getElementById("media_elements")
        .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="RalphJustLetUsIn();"><source src="audio/Ral07.wav" type="audio/mpeg"></audio>`;
            setVoiceVolume();
    document.getElementById("video")
        .innerHTML = `
...
function hereYouAre() {
    ...
    document.getElementById("video")
        .innerHTML = `
        <video playsinline autoplay class="SoundOfVoice" onplaying="setVoiceVolume()" onended="signTheListScreen1()" id="currentVideo"   >
...
function interaction_ralph() {
    ...
    function yesMattieJensenLeftAVisitorsPassForMe() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); hereYouAre()"><source src="audio/Ng01.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function helloHereIsMyPass() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); youMayProceed()"><source src="audio/Ng04.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
}
...
function youMayProceed() {
    document.getElementById("video")
        ...
        document.getElementById("video")
            .innerHTML = `
            <video playsinline autoplay class="SoundOfVoice" id="currentVideo" onended="RalphJustLetUsIn();">
