...
function wellIwasReadingATeleprompter() {
    document.getElementById("video")
        .innerHTML = `
        <video playsinline autoplay class="SoundOfVoice" id="currentVideo"    onended="defaultMattieImage();">
...
function wellTheFirstOnes4() {
    document.getElementById("video")
        .innerHTML = `
        <video playsinline autoplay class="SoundOfVoice" id="currentVideo"    onended="nancyImRunningLate();">
            <source src="video/mattie_wellthefirstoneshadtheletters.webm" type="video/webm">
        </video>
        `
    setVoiceVolume();
...
function ohBeforeIForget() {
    document.getElementById("video")
        .innerHTML = `
            <video playsinline autoplay class="SoundOfVoice" id="currentVideo" onended="removeInventoryGif(); defaultMattieImage();"   >
...
function seeingMattieForTheFirstTime() {
    document
        ...
        .innerHTML = `
                    <video playsinline autoplay class="SoundOfVoice" id="currentVideo"   onended="interaction_mattie_first();">
...
function interaction_mattie_first() {
    ...
    function letters1() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellTheFirstOnes1()"><source src="audio/Nma07.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function letters2() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellTheFirstOnes2()"><source src="audio/Nma07.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function letters3() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellTheFirstOnes3()"><source src="audio/Nma07.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    ...
    function police() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); noAndThatsTheProblem0()"><source src="audio/Nma11.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function policeafterletters() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); noAndThatsTheProblem1()"><source src="audio/Nma11.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function policeafterchocolates() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); noAndThatsTheProblem2()"><source src="audio/Nma11.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function policeafterchocolatesandletters() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); noAndThatsTheProblem3()"><source src="audio/Nma11.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    ...
    function lettersafterpolice() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellTheFirstOnes4()"><source src="audio/Nma07.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function chocolatesafterpolice() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); ricksaMajorChocoholic4()"><source src="audio/Nma08.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    ...
    function chocolates1() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); ricksaMajorChocoholic1()"><source src="audio/Nma08.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function chocolates2() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); ricksaMajorChocoholic2()"><source src="audio/Nma08.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function chocolates3() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); ricksaMajorChocoholic3()"><source src="audio/Nma08.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    ...
    function watch() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); someoneSentHimABrokenWatch()"><source src="audio/Nma09.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function teleprompter() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellIwasReadingATeleprompter()"><source src="audio/Nma10.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function itsAlwaysNice() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); believeMe()"><source src="audio/Nma01.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function imHappyToHelp() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellForThePastMonth()"><source src="audio/Nma02.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function butItCantBeAll() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); yesItCanBeAllThatBad()"><source src="audio/Nma03.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function tellMeAboutTheDeath() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); wellForThePastMonth()"><source src="audio/Nma12.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function weird() {
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); theyreTotallyBizarre()"><source src="audio/Nma05.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
    function haveYouEverReceived() {
        ...
        document.getElementById("media_elements")
            .innerHTML = `
            <audio autoplay class="SoundOfVoice" onended="clearTheAudio(); ohIveGottenSomeOdd()"><source src="audio/Nma06.wav" type="audio/mpeg"></audio>
            `
            setVoiceVolume();
    }
}
